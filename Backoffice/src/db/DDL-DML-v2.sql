...
INSERT INTO `bytebusters2_db`.`CATEGORIAS` (`id`, `nombre`) VALUES ('11', 'Congelados');
...
INSERT INTO `bytebusters2_db`.`PRODUCTOS` (`id`, `nombre`, `descripcion`, `imagen`,`precio`,`usuario_ci`,`activo`) VALUES ('33','2 Cepillos Dental PICO JENNER Duro','2 Cepillos Dental PICO JENNER Duro','33.jpg','460','55271656',1);
...
INSERT INTO `bytebusters2_db`.`PRODUCTOS` (`id`, `nombre`, `descripcion`, `imagen`,`precio`,`usuario_ci`,`activo`) VALUES ('77','Aceite-de-oliva-extra-virgen-OLIVARES-DE-ROCHA-500-ml-1','Aceite de oliva extra virgen OLIVARES DE ROCHA 500 ml','77.jpg','330','55271656',1);
...
INSERT INTO `bytebusters2_db`.`PRODUCTOS_has_PROMOCIONES` (`PRODUCTOS_id`, `PROMOCIONES_id`) VALUES ('22', '1');
INSERT INTO `bytebusters2_db`.`PRODUCTOS_has_PROMOCIONES` (`PRODUCTOS_id`, `PROMOCIONES_id`) VALUES ('42', '1');
INSERT INTO `bytebusters2_db`.`PRODUCTOS_has_PROMOCIONES` (`PRODUCTOS_id`, `PROMOCIONES_id`) VALUES ('62', '1');