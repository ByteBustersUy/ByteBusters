...
---------------------------------
*/
INSERT INTO `bytebusters2_db`.`PRODUCTOS` (`id`, `nombre`, `descripcion`, `imagen`,`precio`,`usuario_ci`,`activo`) VALUES ('1', 'Pack 3 Rollos de Cocina NOVA Clásico', 'Rollos de papel doble hoja con alta absorción que permite retener mayor cantidad de líquido y aseguran un rendimiento más económico en todas las necesidades del hogar.', '1.jpg','1200','55271656',1);
INSERT INTO `bytebusters2_db`.`PRODUCTOS` (`id`, `nombre`, `descripcion`, `imagen`,`usuario_ci`,`activo`) VALUES ('2', 'Tijera MAPED Sensoft 13 cm mango de goma', 'Los Mejores útiles para escolares encontralos en la web', '2.jpg','55271656',1);
INSERT INTO `bytebusters2_db`.`PRODUCTOS` (`id`, `nombre`, `descripcion`, `imagen`,`usuario_ci`,`activo`) VALUES ('3','Lubricante WD-40 flexi tapa 220g','Lubricante WD-40 flexi tapa 220g, producto de excelente calidad.', '3.jpg','55271656',1);
...
INSERT INTO `bytebusters2_db`.`PRODUCTOS` (`id`, `nombre`, `descripcion`, `imagen`,`usuario_ci`,`activo`) VALUES ('5', 'Agua JANE 1L', 'El baño y la cocina son áreas altamente contaminadas de toda la casa, pero con agua Jane estan limpios en un segundo', '5.jpg','55271656',1);
...
INSERT INTO `bytebusters2_db`.`PRODUCTOS` (`id`, `nombre`, `descripcion`, `imagen`,`usuario_ci`,`activo`) VALUES ('12','Cinta adhesiva TEORIA + 24mm x 50 m','Cinta adhesiva TEORIA + 24mm x 50 m','12.jpg','55271656',1);
